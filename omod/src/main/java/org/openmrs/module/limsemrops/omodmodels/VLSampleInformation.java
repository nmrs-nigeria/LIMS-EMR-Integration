...
public class VLSampleInformation {
	...
	private String pregnantBreastfeadingStatus;
	...
	public String getPregnantBreastfeadingStatus() {
		return pregnantBreastfeadingStatus;
	}
	
	public void setPregnantBreastfeadingStatus(String pregnantBreastfeadingStatus) {
		this.pregnantBreastfeadingStatus = pregnantBreastfeadingStatus;
	}
